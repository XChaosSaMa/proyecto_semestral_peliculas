...
public class Administrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Administrar Proveedores");
        ...
        jButton4.setText("Administrar Películas");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        AdminEmpleados administrarusr = new AdminEmpleados();
        administrarusr.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        AdminProveedores administrarprov = new AdminProveedores();
        administrarprov.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        AdminPeliculas adpeli = new AdminPeliculas();
        adpeli.setVisible(true);
        dispose();
